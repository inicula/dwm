...
static const char *fonts[]          = { "Berkeley Mono SemiCondensed:pixelsize=30,antialias=false" };
static const char dmenufont[]       = "Berkeley Mono SemiCondensed:pixelsize=30,antialias=false";
